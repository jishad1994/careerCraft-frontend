...
export const USER_ROUTES: Routes = [
    {
        path: "",
        loadComponent: () =>
            import("../../layouts/user/user-layout/user-layout.component").then((m) => m.UserLayoutComponent),
        ...
        children: [
            ...
            {
                path: "jobs",
                loadChildren: () => import("./user.jobs.routes").then((m) => m.userJobRoutes),
            },

            {
                path: "my-applications",
                loadChildren: () => import("./user.applications.routes").then((m) => m.userJobApplicationRoutes),
            },
            {
                path: "messages",
                loadComponent: () =>
            ...
            },
            {
                path: "resume-builder",
                loadComponent: () =>
                    import("../../features/user/resume-builder/resume-builder.component").then(
